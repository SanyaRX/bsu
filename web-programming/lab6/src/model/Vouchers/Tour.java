...
public class Tour extends TravelVoucher implements Serializable {
     ...
     * */
    public Tour(String placesToVisit){
        this(placesToVisit, VehicleType.BUS, NutritionType.THREE_TIMES, Duration.TWO_WEEKS);
    }
